  ...
  return (
    <section id="about" className="min-h-screen px-8 pt-0 md:pt-16 flex flex-col items-center justify-center pb-20 md:pb-0">
      <div className="flex flex-col space-y-6 md:space-y-0 md:grid md:grid-cols-6 md:grid-rows-2 md:gap-4">
        ...
        <div className="hidden md:block col-start-3 col-span-2 row-start-1 row-span-1 rounded-lg bg-[var(--card)] text-[var(--text)] p-3 md:p-4 shadow-md hover:shadow-lg transition-shadow transform hover:scale-102 transition-transform duration-200">
        ...
        <div className="hidden md:flex md:col-start-3 md:col-span-1 md:row-start-2 md:row-span-1 rounded-lg bg-[var(--card)] text-[var(--text)] p-4 shadow-md items-center justify-center hover:shadow-lg transition-shadow transform hover:scale-102 transition-transform duration-200">
        ...
        <div className="hidden md:flex md:col-start-4 md:col-span-1 md:row-start-2 md:row-span-1 rounded-lg bg-[var(--card)] text-[var(--text)] p-4 shadow-md items-center justify-center hover:shadow-lg transition-shadow transform hover:scale-102 transition-transform duration-200">
          <img src={eagleScoutLogo} alt="Eagle Scout Logo" width={100} />
        </div>

        {/* Right: About Me (2x2) */}
        <div className="col-start-5 col-span-2 row-start-1 row-span-2 rounded-lg bg-[var(--card)] text-[var(--text)] p-3 md:p-4 shadow-md hover:shadow-lg transition-shadow transform hover:scale-102 transition-transform duration-200">
