  ...
  return (
    <section id="about" className="px-8 pt-0 md:pt-16 flex flex-col items-center justify-center pb-20 md:pb-0" style={{ minHeight: 'calc(var(--vh, 1vh) * 100)' }}>
      <div className="flex flex-col space-y-6 md:space-y-0 md:grid md:grid-cols-6 md:grid-rows-2 md:gap-4">
        {/* Left: Name block (2x2) */}
        <div className="col-start-1 col-span-2 row-start-1 row-span-2 rounded-lg glass-surface text-[var(--text)] p-3 md:p-4 mb-6 md:mb-0 transition-transform duration-200 hover:scale-102 flex flex-col md:justify-between">
        ...
        <div className="hidden md:block col-start-3 col-span-2 row-start-1 row-span-1 rounded-lg glass-surface text-[var(--text)] p-3 md:p-4 transition-transform duration-200 hover:scale-102">
        ...
        <div className="hidden md:flex md:col-start-3 md:col-span-1 md:row-start-2 md:row-span-1 rounded-lg glass-surface text-[var(--text)] p-4 items-center justify-center transition-transform duration-200 hover:scale-102">
        ...
        <div className="hidden md:flex md:col-start-4 md:col-span-1 md:row-start-2 md:row-span-1 rounded-lg glass-surface text-[var(--text)] p-4 items-center justify-center transition-transform duration-200 hover:scale-102">
